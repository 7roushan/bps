...
const HexagonIcon = ({ Icon, gradient, index }) => {
  ...
  return (
    <Box sx={{ position: 'relative', zIndex: 1 }}>
      ...
      >
        <Icon sx={{ fontSize: "38px", color: "#ffffff", filter: "drop-shadow(1px 1px 2px rgba(0,0,0,0.2))" }} />
      </Box>
      <Box sx={{
        position: 'absolute',
        top: -45,
  ...
  return (
    ...
    >
      <Box position="relative" zIndex={1}>
        ...
        >
          Experience effortless tracking with our intuitive system. Uncover real-time insights into your shipment's journey. Elevate your order management with a seamless process, ensuring transparency and peace of mind.
        </Typography>
